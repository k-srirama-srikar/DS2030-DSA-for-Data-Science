...
class LinkedList:
    ...
    def sort_by_time(self):
        ...
        pre  = Node(self.head.contestant, self.head)
        while self.head != None:
            nex = self.head.next
            if pre.contestant.time >= self.head.contestant.time:
                pre = pre
            while pre.next and pre.next.contestant.time < self.head.contestant.time:
                pre = pre.next
...
def test():
    contestants = [
        Contestant("Contestant A", 1, "Country A", 6),
        Contestant("Contestant B", 2, "Country B", 7),
        Contestant("Contestant C", 3, "Country C", 4),
        Contestant("Contestant D", 4, "Country D", 76),
        Contestant("Contestant E", 5, "Country E", 56),
        Contestant("Contestant F", 6, "Country F", 78),
        Contestant("Contestant G", 7, "Country G", 9),
        Contestant("Contestant H", 8, "Country H", 20)
    ]
